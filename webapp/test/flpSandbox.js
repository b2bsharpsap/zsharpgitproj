		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Git App Title",
									"targetURL": "#zsharpgitproj-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsharpgitproj-display": {
								"semanticObject": "zsharpgitproj",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsharpgitproj",
									"url": sap.ui.require.toUrl("zsharpgitproj")
								}
							}
						}
					}
